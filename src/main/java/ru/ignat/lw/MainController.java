...
public class MainController{
    ...
    @FXML
    private TableColumn<Sale, String> SaleClienFIO;
    ...
    void ClientAddBtnClicked(MouseEvent event) throws IOException {
        ...
        FXMLLoader loader = new FXMLLoader(MainController.class.getResource("customer-add-page.fxml"));//загружается содержимое окна из FXML файла
    ...
    void SaleAddBtnClicked(MouseEvent event) {
        try {
            ...
            dialogStage.initOwner(st);// указываем главное окно
            //создаём новую сцену и добавляем в неё панель со всем содержимым
            FXMLLoader loader = new FXMLLoader(MainController.class.getResource("sale-add-page.fxml"));//загружается содержимое окна из FXML файла
            Scene scene = new Scene(loader.load());
            dialogStage.setScene(scene);
            //показываем окно
            dialogStage.showAndWait();
    ...
    void VoucherAddBtnClicked(MouseEvent event) {
        try {
            ...
            dialogStage.initOwner(st);// указываем главное окно
            //создаём новую сцену и добавляем в неё панель со всем содержимым
            FXMLLoader loader = new FXMLLoader(MainController.class.getResource("vouch-add-page.fxml"));//загружается содержимое окна из FXML файла
            Scene scene = null;
    ...
    void MostByingClicked(MouseEvent event) {
        try {
            ...
            dialogStage.initOwner(st);// указываем главное окно
            //создаём новую сцену и добавляем в неё панель со всем содержимым
            FXMLLoader loader = new FXMLLoader(MainController.class.getResource("vouch-popular-page.fxml"));//загружается содержимое окна из FXML файла
            Scene scene = null;
            scene = new Scene(loader.load());
            dialogStage.setScene(scene);
            //показываем окно
    ...
    void addDiscount(MouseEvent event) {
        try{
            ...
            dialogStage.initOwner(st);// указываем главное окно
            //создаём новую сцену и добавляем в неё панель со всем содержимым
            FXMLLoader loader = new FXMLLoader(MainController.class.getResource("discount-add-page.fxml"));//загружается содержимое окна из FXML файла
            Scene scene = null;
            scene = new Scene(loader.load());
            dialogStage.setScene(scene);
            //показываем окно
    ...
    void addEmployee(MouseEvent event) {
        try{
            ...
            dialogStage.initOwner(st);// указываем главное окно
            //создаём новую сцену и добавляем в неё панель со всем содержимым
            FXMLLoader loader = new FXMLLoader(MainController.class.getResource("employee-add-page.fxml"));//загружается содержимое окна из FXML файла
            Scene scene = null;
            scene = new Scene(loader.load());
            dialogStage.setScene(scene);
            //показываем окно
    ...
    void addService(MouseEvent event) {
        try{
            ...
            dialogStage.initOwner(st);// указываем главное окно
            //создаём новую сцену и добавляем в неё панель со всем содержимым
            FXMLLoader loader = new FXMLLoader(MainController.class.getResource("service-add-page.fxml"));//загружается содержимое окна из FXML файла
            Scene scene = null;
            scene = new Scene(loader.load());
            dialogStage.setScene(scene);
            //показываем окно
    ...
    void AddTown(MouseEvent event) {
        try{
            ...
            dialogStage.initOwner(st);// указываем главное окно
            //создаём новую сцену и добавляем в неё панель со всем содержимым
            FXMLLoader loader = new FXMLLoader(MainController.class.getResource("town-add-page.fxml"));//загружается содержимое окна из FXML файла
            Scene scene = null;
            scene = new Scene(loader.load());
            dialogStage.setScene(scene);
            //показываем окно
